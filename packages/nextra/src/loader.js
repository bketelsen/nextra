import { getFileName, getLocaleFromFilename, parseJsonFile, removeExtension } from './utils'
...
${files
        .map((file, index) =>
          `import Page_${index}${file.ssg || file.ssr ? `, { ${file.ssg ? 'getStaticProps' : 'getServerSideProps'} as page_data_${index} }` : ''
